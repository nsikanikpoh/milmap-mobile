...
/**
 * Generated class for the OprospectsPage page.
 *
...
@IonicPage()
@Component({
  selector: 'page-oprospects',
  templateUrl: 'oprospects.html',
})
export class OprospectsPage {
  ...
  ionViewDidLoad() {
    this.showLoader();
    this.user.opportunityP().subscribe((resp: any) => {
      if (resp){
